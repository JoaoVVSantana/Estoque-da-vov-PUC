...
estoque.hasOne(historico, {foreignKey:'id_historico', as:'historicoUm'});
estoque.belongsTo(gerente, { foreignKey: 'id_gerente', as: 'gerenteUm' });
...
alteracao.belongsTo(historico, { foreignKey: 'id_historico', as: 'historicoUm' });
alteracao.belongsTo(gerente, { foreignKey: 'id_gerente', as: 'gerenteUm' });
